...
[요청 사항]
1. 해당 매장의 업종, 평균 재방문률, 공략 대상 고객층 데이터를 전략 소개하기에 앞서 한 번 짚어주세요.
2. '{month}'월의 '{weather}'날씨를 고려해 '{target_seg}' 고객층을 공략하는 전략 3가지.
3. 각 전략에 적합한 홍보 채널과 이유 설명.
4. 100자 이내의 홍보 문구 작성 (이모지, 해시태그 포함).
"""
